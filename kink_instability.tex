...
\begin{figure}[t]
  ...
  \begin{center}
    \begin{overpic}[width=\textwidth]{images/kink_instability/field_line_plots/initial_field/initial_field_cropped.png}
  ...
  \begin{subfigure}[b]{0.48\textwidth}
  \begin{center}
    \begin{overpic}[width=\textwidth]{images/kink_instability/alpha_profile.pdf}
...
%\begin{figure}[t]
  ...
  %\begin{subfigure}[b]{0.48\textwidth}
  %\begin{center}
    %\begin{overpic}[width=\textwidth]{images/kink_instability/s_function.pdf}
...
\hspace*{-5mm}
\vspace{5mm} 
   \begin{overpic}[width=\textwidth]{images/kink_instability/log_kinetic_energy_over_time.pdf}
...
\hfill
 \begin{subfigure}[b]{0.48\textwidth}
%  \begin{center}
    \begin{overpic}[width=\textwidth]{images/kink_instability/field_line_plots/cropped/v1e-4r5e-4.5-isotropic_0009_cropped.png}
      \put (50,40) {\small\textbf{(b)}}
    \end{overpic}
    \begin{overpic}[width=\textwidth]{images/kink_instability/field_line_plots/cropped/v1e-4r5e-4.5-isotropic_0010_cropped.png}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
      \centering
      \begin{overpic}[]{images/kink_instability/parallel_kinetic_energy_over_time.pdf}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
      \centering
      \begin{overpic}[]{images/kink_instability/perp_kinetic_energy_over_time.pdf}
        \put (50,55) {\small\textbf{(b)}}
      \end{overpic}
    \end{subfigure}
    \begin{subfigure}[t]{0.49\textwidth}
      \centering
      \begin{overpic}[]{images/kink_instability/current_density_over_time.pdf}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/magnetic_energy_density_over_time.pdf}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
      \centering
      \begin{overpic}[width=\linewidth]{images/kink_instability/max_parallel_electric_field.pdf}
        \put (50,60) {\small\textbf{(a)}}
      \end{overpic}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
      \centering
      \begin{overpic}[width=\linewidth]{images/kink_instability/mean_difference_in_connectivity.pdf}
...
\begin{figure}[t]
  ...
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_isotropic_current_density_0013.pdf}
  ...
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_isotropic_current_density_0015.pdf}
  ...
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_isotropic_current_density_0020.pdf}
  ...
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_switching_current_density_0013.pdf}
  ...
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_switching_current_density_0015.pdf}
  ...
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_switching_current_density_0020.pdf}
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_isotropic_current_density_0025.pdf}
        \put (3,92) {\small\textbf{(a)}}
      \end{overpic}
  \end{center}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_isotropic_current_density_0030.pdf}
        \put (3,92) {\small\textbf{(b)}}
      \end{overpic}
  \end{center}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_isotropic_current_density_0035.pdf}
        \put (3,92) {\small\textbf{(c)}}
      \end{overpic}
  \end{center}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_switching_current_density_0025.pdf}
        \put (3,92) {\small\textbf{(d)}}
      \end{overpic}
  \end{center}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_switching_current_density_0030.pdf}
        \put (3,92) {\small\textbf{(e)}}
      \end{overpic}
  \end{center}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\textwidth}
  \begin{center}
      \begin{overpic}[width=\textwidth]{images/kink_instability/python-slices/final_switching_current_density_0035.pdf}
        \put (3,92) {\small\textbf{(f)}}
      \end{overpic}
  \end{center}
  \end{subfigure}
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
  \begin{center}
    \begin{overpic}[width=\textwidth]{images/kink_instability/field_line_plots/cropped/v1e-4r5e-4.5-isotropic_0035_cropped.png}
  ...
  \begin{subfigure}[b]{0.48\textwidth}
  \begin{center}
    \begin{overpic}[width=\textwidth]{images/kink_instability/field_line_plots/cropped/v1e-4r5e-4.5-switching_0035_cropped.png}
      \put (50,40) {\small\textbf{(b)}}
    \end{overpic}
  \end{center}
  \end{subfigure}
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
  \begin{center}
    \begin{overpic}[width=\textwidth]{images/kink_instability/field_line_plots/cropped/v1e-4r5e-4.5-isotropic_0062_cropped.png}
      \put (50,40) {\small\textbf{(a)}}
    \end{overpic}
  \end{center}
  \end{subfigure}
  \begin{subfigure}[b]{0.48\textwidth}
  \begin{center}
    \begin{overpic}[width=\textwidth]{images/kink_instability/field_line_plots/cropped/v1e-4r5e-4.5-switching_0059_cropped.png}
      \put (50,40) {\small\textbf{(b)}}
    \end{overpic}
  \end{center}
  \end{subfigure}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/ohmic_heating_over_time.pdf}
        \put (40,60) {\small\textbf{(a)}}
      \end{overpic}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/viscous_heating_over_time.pdf}
        \put (40,60) {\small\textbf{(b)}}
      \end{overpic}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/total_heating_over_time.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.5\linewidth]{images/kink_instability/kinetic-energy-changing-s.pdf}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/max_ke_split_inst_changing_viscosity.pdf}
    ...
    \begin{subfigure}[t]{0.5\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/max_ke_split_inst_changing_resistivity.pdf}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/visc_heating_varying_viscosity.pdf}
        \put (50,60) {\small\textbf{(a)}}
      \end{overpic}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.32\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/ohmic_heating_varying_viscosity.pdf}
        \put (50,60) {\small\textbf{(b)}}
      \end{overpic}
    \end{subfigure}
    ~
    \begin{subfigure}[t]{0.32\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/max_kinetic_changing_visc.pdf}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/growth_rate_varying_viscosity.pdf}
        \put (50,62) {\small\textbf{(a)}}
      \end{overpic}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.5\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/max_early_time_kinetic_changing_visc.pdf}
        \put (50,62) {\small\textbf{(b)}}
      \end{overpic}
    \end{subfigure}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/visc_heating_varying_resistivity.pdf}
        \put (50,60) {\small\textbf{(a)}}
      \end{overpic}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.5\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/ohmic_heating_varying_resistivity.pdf}
        \put (50,60) {\small\textbf{(b)}}
      \end{overpic}
    \end{subfigure}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/growth_rate_varying_resistivity.pdf}
        \put (50,62) {\small\textbf{(a)}}
      \end{overpic}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.5\textwidth}
      \centering
      \begin{overpic}[width=\textwidth]{images/kink_instability/max_kinetic_changing_resist.pdf}
        \put (50,62) {\small\textbf{(b)}}
      \end{overpic}
    \end{subfigure}
    \caption{\textit{Linear growth rate and maximum (in time) kinetic energy as
