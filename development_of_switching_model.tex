...
\begin{figure}[t]
  ...
  \mycaption{Coefficients of the terms in the Braginskii tensor~\eqref{eq:brag_new2} normalised against $\eta_0$.}{In these plots, $\alpha = 10^{8}$, a value realistic of the corona.\todo{change legend to paralell, perp, drift, rather than values}}%
...
\todo{add labels to all 2d slices}
...
\midrule
$N=100$ & $4.04 \times 10^{-3}$ & $5.74 \times 10^{-5}$ & $7.13 \times 10^{-5}$ & $8.39 \times 10^{-5}$ & $4.66 \times 10^{-5}$\\
$N=500$ & TODO  & $5.25 \times 10^{-5}$ & $6.81 \times 10^{-5}$ & $7.80 \times 10^{-5}$ & $4.39 \times 10^{-5}$  \end{tabular}
\end{table}

\todo{calculate total isotropic heating for this table}
