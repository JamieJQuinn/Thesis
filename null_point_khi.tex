...
After $t=15$, however, the collapse of the null appears to enhance the reconnection in the isotropic case and suppress it in the switching case. Why this is is not entirely clear \todo{when the plots come back}.
...
\todo{redo shear layers as proper plots}
...
\todo{redo kinetic energy plots as separate plots}

\todo{properly reference ke plots}
...
\todo{add visc and ohmic heating}
