...
\begin{figure}[t]
  ...
  \end{subfigure}
  \mycaption{Energy measures and reconnection rate as functions of time.}{Vertical, dotted lines signify the beginning of the null collapse in the isotropic (blue) and switching (orange) cases.}
\end{figure}
