...
\begin{figure}[t]
  ...
  \caption{\emph{Dependence of $\eta_1$ and $\eta_3$ on magnetic field strength.} The collision time $\tau = 0.77$ s, corresponding to a typical coronal temperature of $T=10^6$ K. Both expressions are normalised against $\eta_0$.}
\label{fig:visc_dep}%
\end{figure}
