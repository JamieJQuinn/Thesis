...
\begin{figure}[t]
  ...
  \caption{\emph{Driver radial velocity profile $u_r(r)$ and acceleration profile $u_t(t)$.}}
...
\begin{figure}[t]
  \centering
    ...
    \end{subfigure}
\caption{\emph{Pressure profiles during the development of the fluting and kink instabilities.} Shown are slices of pressure through $z=0$ where $\eta = 10^{-4}$ and the viscosity model is switching. Note the difference in colour scale in Figure~\ref{fig:swi-4_pressure_15}. The development in the isotropic case is similar.}
...
\begin{figure}[t]
  \centering
    ...
    \end{subfigure}
  \caption{\emph{Kinetic energy as a function of time showing the development and measured growth rates of the fluting and kink instabilities.} Both plots are from results where $\eta=10^{-4}$.}
...
\begin{figure}[t]
  \centering
    ...
    \end{subfigure}
\caption{\emph{Stability and linear growth rate of the fluting instability.} In~\ref{fig:suydam_condition_4}, Suydam's stability criterion and contributing terms (LHS of~\eqref{eq:suydams_criterion})  are plotted and in~\ref{fig:growth_rate_4} the predicted linear growth rate~\eqref{eq:fluting_growth_rate2} is plotted. Both plots are produced at $t=20$ for $\eta=10^{-4}$ and using the switching model. The location of the peak linear growth rate is also shown.}
...
\begin{figure}[t]
  \centering
    ...
    \end{subfigure}
\caption{\emph{Pressure and velocity perturbations in $z$ (corresponding to the fluting and kink instabilities, respectively) and of the resonance function $m B_{\theta}(r)/r + kB_z(r)$ as a function of $r$ using the observed fluting perturbation wavenumbers.} All plots are from snapshots at $t=26$ where $\eta=10^{-4}$ and the viscosity model is switching.}
...
\begin{figure}[t]
  \centering
    ...
    \end{subfigure}
\caption{\emph{Kinetic energy as a function of time in the cases where $\eta=10^{-3}$.} The results from both viscosity models are shown. The fluting instability appears earlier than where $\eta=10^{-4}$ and the growth rate of the kink instability is decreased.}
