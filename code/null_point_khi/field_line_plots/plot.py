...
def save_fig(data_fname, fig_fname, timedump):
    ...
    IsosurfaceAtts.contourValue = (100)
    ...
    View3DAtts.viewNormal = (0.0, -5.0, 1.0)
    View3DAtts.focus = (0, 0, -0.000390016)
    View3DAtts.viewUp = (0.0, 1.0, 5.0)
    ...
    CloseDatabase("localhost:"+data_fname)
...
def main():
    ...
    for filename in filenames:
        ...
        t_step = re.search('/(\d+)_preprocessed.vti', filename).groups()[0]
