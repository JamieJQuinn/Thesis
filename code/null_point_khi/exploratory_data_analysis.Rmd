...
for run_folder in ["v-4r-5-isotropic"]:
...
#             image1 = get_variable_slice(iso_sdf, "magnetic_tension_x", slice_dim, slice_loc).T
#             image2 = get_variable_slice(iso_sdf, "lorentz_force_x", slice_dim, slice_loc-0.01).T
#             image = (image1 + image2)/2.0
            #     print(image.shape)
            image = get_variable_slice(iso_sdf, "magnetic_tension_x", slice_dim, slice_loc).T
...
# Extremely high resistivity runs (eta=1e-2)

```{python}
run_folder = "v-4r-2-switching"
folder = data_folder + parameter_study_folder + run_folder + "/Data/"
